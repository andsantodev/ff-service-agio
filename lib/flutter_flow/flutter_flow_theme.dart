...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF13293D);
  late Color secondary = const Color(0xFF18AA99);
  late Color tertiary = const Color(0xFF1A3449);
  late Color alternate = const Color(0xFFCFD5E0);
  late Color primaryText = const Color(0xFF101518);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFDFBFA);
